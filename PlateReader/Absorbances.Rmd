...
This is set up to work with a 96 well plate (8 x 12) where each sample has three replicates going across the rows. An example is shown where letters are different samples:
